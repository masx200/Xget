...
describe('Platform Configuration', () => {
  ...
  describe('DNS over HTTPS (DoH) Providers Support', () => {
      ...
      const testCases = [
        {
          ...
          inputPath: '/cloudflare-dns.com',
          expectedPath: ''
        },
        {
          provider: 'dns.google',
          inputPath: '/dns.google',
          expectedPath: '/resolve'
        },
        {
          provider: 'dns.quad9.net',
          inputPath: '/dns.quad9.net',
          expectedPath: ''
        },
        {
          provider: 'dns.nextdns.io',
          inputPath: '/dns.nextdns.io',
          expectedPath: ''
        },
        {
          provider: 'dns.adguard.com',
          inputPath: '/dns.adguard.com',
          expectedPath: ''
        },
        {
          provider: 'doh.opendns.com',
          inputPath: '/doh.opendns.com',
          expectedPath: ''
        },
        {
          provider: 'dns.alidns.com',
          inputPath: '/dns.alidns.com',
          expectedPath: ''
        },
        {
          provider: 'doh.pub',
        ...
        {
          provider: 'doh.360.cn',
          inputPath: '/doh.360.cn',
          expectedPath: ''
        },
        {
          provider: 'dns.huawei.com',
          inputPath: '/dns.huawei.com',
          expectedPath: ''
        },
        {
          provider: 'dns.mullvad.net',
          inputPath: '/dns.mullvad.net',
          expectedPath: ''
        },
        {
          provider: 'dns.controld.com',
          inputPath: '/dns.controld.com',
          expectedPath: ''
        }
      ];
    ...
    it('should handle DoH provider edge cases', () => {
      ...
      expect(
        transformPath('/cloudflare-dns.com?name=example.com&type=A', 'cloudflare-dns.com')
      ).toBe('?name=example.com&type=A');

      // Test with fragments
      expect(transformPath('/dns.google#section', 'dns.google')).toBe('/resolve#section');
    });
  });
});
