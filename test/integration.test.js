...
describe("Integration Tests", () => {
  describe("End-to-End Platform Integration", () => {
    it("should proxy GitHub file requests correctly", async () => {
      const testUrl =
        "https://example.com/gh/microsoft/vscode/blob/main/package.json";
    ...
    it("should handle GitHub raw file requests", async () => {
      const testUrl =
        "https://example.com/gh/microsoft/vscode/raw/main/README.md";
      const response = await SELF.fetch(testUrl, { method: "HEAD" });
    ...
    it("should proxy GitLab file requests correctly", async () => {
      const testUrl =
        "https://example.com/gl/gitlab-org/gitlab/-/raw/master/package.json";
      const response = await SELF.fetch(testUrl, { method: "HEAD" });
    ...
    it("should handle conda package requests", async () => {
      const testUrl =
        "https://example.com/conda/pkgs/main/linux-64/repodata.json";
      const response = await SELF.fetch(testUrl, { method: "HEAD" });
  ...
  describe("Git Protocol Integration", () => {
    ...
    it("should handle Git upload-pack requests", async () => {
      const testUrl =
        "https://example.com/gh/microsoft/vscode.git/git-upload-pack";
      const response = await SELF.fetch(testUrl, {
        method: "POST",
        headers: {
  ...
  describe("Git LFS Protocol Integration", () => {
    ...
    it("should handle LFS batch API requests", async () => {
      const testUrl =
        "https://example.com/gh/microsoft/vscode.git/objects/batch";
      const response = await SELF.fetch(testUrl, {
        method: "POST",
        headers: {
  ...
  describe("Content Type Handling", () => {
    it("should preserve content types from upstream", async () => {
      const testCases = [
        {
          url: "https://example.com/gh/test/repo/image.png",
          expectedType: "image",
        },
        {
          url: "https://example.com/gh/test/repo/data.json",
          expectedType: "json",
        },
        {
          url: "https://example.com/gh/test/repo/style.css",
          expectedType: "css",
        },
        {
          url: "https://example.com/gh/test/repo/script.js",
