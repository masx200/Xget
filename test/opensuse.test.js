...
describe("openSUSE Platform Configuration", () => {
  ...
  it("should transform openSUSE paths correctly", () => {
    const testCases = [
      ...
      {
        input:
          "/opensuse/tumbleweed/repo/oss/x86_64/firefox-121.0-1.1.x86_64.rpm",
      ...
      {
        input:
          "/opensuse/update/leap/15.5/oss/x86_64/systemd-249.17-150400.8.35.1.x86_64.rpm",
        expected:
          "/update/leap/15.5/oss/x86_64/systemd-249.17-150400.8.35.1.x86_64.rpm",
